...
export let player = {
  name: "Elven Mage",
  id: "elf-mage",
  race: "elf", // Player race (affects story choices)
  type: "light", // Combat type (affects damage/resistance)
  
  // Character-specific available races (elf subspecies/variants)
  availableRaces: ["elf", "dark-elf", "wood-elf", "high-elf"], // This character can only choose elf variants
  
  height: 165, // Height in cm (medium category: 150-180cm)
  weight: 55, // Weight in kg (used to do calculations like pin or fall damage)
  life: 0,
  mana: 0,
  level: 1,
